...
import {LAYOUT_VALUES, isFlowHorizontal} from '../../_private-utils';
...
const inputs = [
  'snLayoutAlign', 'snLayoutAlign.xs', 'snLayoutAlign.sm', 'snLayoutAlign.md',
  'snLayoutAlign.lg', 'snLayoutAlign.xl', 'snLayoutAlign.lt-sm', 'snLayoutAlign.lt-md',
  'snLayoutAlign.lt-lg', 'snLayoutAlign.lt-xl', 'snLayoutAlign.gt-xs', 'snLayoutAlign.gt-sm',
  'snLayoutAlign.gt-md', 'snLayoutAlign.gt-lg'
];
const selector = `
  [snLayoutAlign], [snLayoutAlign.xs], [snLayoutAlign.sm], [snLayoutAlign.md],
  [snLayoutAlign.lg], [snLayoutAlign.xl], [snLayoutAlign.lt-sm], [snLayoutAlign.lt-md],
