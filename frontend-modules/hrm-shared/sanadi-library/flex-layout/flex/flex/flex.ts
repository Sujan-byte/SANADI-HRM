...
import { LAYOUT_CONFIG, LayoutConfigOptions } from '../../core/tokens';
import { BaseDirective2, ElementMatcher, MediaMarshaller, StyleBuilder, StyleDefinition, StyleUtils, validateBasis } from '../../core/public-api';
import { extendObject, isFlowHorizontal } from '../../_private-utils';
...
const inputs = [
  'snFlex', 'snFlex.xs', 'snFlex.sm', 'snFlex.md',
  'snFlex.lg', 'snFlex.xl', 'snFlex.lt-sm', 'snFlex.lt-md',
  'snFlex.lt-lg', 'snFlex.lt-xl', 'snFlex.gt-xs', 'snFlex.gt-sm',
  'snFlex.gt-md', 'snFlex.gt-lg'
];
const selector = `
  [snFlex], [snFlex.xs], [snFlex.sm], [snFlex.md],
  [snFlex.lg], [snFlex.xl], [snFlex.lt-sm], [snFlex.lt-md],
