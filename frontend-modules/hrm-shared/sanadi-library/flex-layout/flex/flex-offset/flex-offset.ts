...
import {isFlowHorizontal} from '../../_private-utils';
...
const inputs = [
  'snFlexOffset', 'snFlexOffset.xs', 'snFlexOffset.sm', 'snFlexOffset.md',
  'snFlexOffset.lg', 'snFlexOffset.xl', 'snFlexOffset.lt-sm', 'snFlexOffset.lt-md',
  'snFlexOffset.lt-lg', 'snFlexOffset.lt-xl', 'snFlexOffset.gt-xs', 'snFlexOffset.gt-sm',
  'snFlexOffset.gt-md', 'snFlexOffset.gt-lg'
];
const selector = `
  [snFlexOffset], [snFlexOffset.xs], [snFlexOffset.sm], [snFlexOffset.md],
  [snFlexOffset.lg], [snFlexOffset.xl], [snFlexOffset.lt-sm], [snFlexOffset.lt-md],
...
export class FlexOffsetDirective extends BaseDirective2 implements OnChanges {
  ...
  /**
   * Using the current snFlexOffset value, update the inline CSS
