...
import {LAYOUT_VALUES} from '../../_private-utils';
...
const inputs = [
  'snLayoutGap', 'snLayoutGap.xs', 'snLayoutGap.sm', 'snLayoutGap.md',
  'snLayoutGap.lg', 'snLayoutGap.xl', 'snLayoutGap.lt-sm', 'snLayoutGap.lt-md',
  'snLayoutGap.lt-lg', 'snLayoutGap.lt-xl', 'snLayoutGap.gt-xs', 'snLayoutGap.gt-sm',
  'snLayoutGap.gt-md', 'snLayoutGap.gt-lg'
];
const selector = `
  [snLayoutGap], [snLayoutGap.xs], [snLayoutGap.sm], [snLayoutGap.md],
  [snLayoutGap.lg], [snLayoutGap.xl], [snLayoutGap.lt-sm], [snLayoutGap.lt-md],
